...
public class OwnerServiceImpl implements OwnerService {
    ...
    //邮件内容
        ...
        sb.append("<a href=\"http://106.14.70.91:8080/web-ssm/owner/activate?email=");
        sb.append(email);
        sb.append("&validateCode=");
        sb.append(DigestUtils.md5DigestAsHex(email.getBytes()));
        sb.append("\">http://106.14.70.91:8080/owner/activate?&email=");
        sb.append(email);
        sb.append("&validateCode=");
    ...
    public List<IncomeBo> getIncome(TimeCondition con, Long ownerId) {
        Long shopId = shopDao.selectShopByOwnerId(ownerId).getId();
        List<IncomeBo> list = shopIncomeDao.getIncomeByTime(con, shopId);
        if(list == null) {
